...
export default function Home() {
  return (
    <div className="bg-white px-2 py-32 md:px-0">
      <div className="container mx-auto max-w-6xl items-center xl:px-5">
        <div className="flex flex-wrap items-center sm:-mx-3">
          <div className="w-full md:w-1/2 md:px-3">
            <div className="space-y-6 sm:max-w-md lg:max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row sm:space-x-4">
                <Link
                  to="/countries"
                  className="flex items-center justify-center rounded-md bg-indigo-600 px-6 py-3 text-lg text-white hover:bg-indigo-700"
                >
                  Explore Now
                  <svg
          ...
          <div className="w-full md:w-1/2">
            <div className="overflow-hidden rounded-md shadow-xl">
              <img
                src="https://hips.hearstapps.com/hmg-prod/images/places-in-italy-lead-marco-bottigelli-65e6208eb4a69.jpg"
